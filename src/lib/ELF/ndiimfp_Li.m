function diimfp = ndiimfp_Li(osc,E0,depth,alpha,interface,decdigs,varargin)
%%
%{
...
if nargin<5
    ...
    if strcmp(interface,'bulk')
        if depth==0
            diimfp = x_in_clear_b./0.5./trapz(osc.eloss,x_in_clear_b);
        else
